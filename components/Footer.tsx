  ...
  return (
    <>
      <div className=" w-full bg-white shadow-lg xs:hidden">
        <div className="fixed bottom-12 mx-auto flex w-screen max-w-5xl items-center justify-between bg-white px-8 py-2 text-gray-500">
          <Tabs />
        </div>
      </div>
      <div className="fixed bottom-0 mx-auto w-full items-center bg-slate-200 text-center text-xs text-gray-500">
